...
class SimpleController(Node):
    ...
    def __init__(self):
        ...
        self.vel_sub_ = self.create_subscription(Twist, "mybot_controller/cmd_vel_unstamped", self.velCallback, 10)
        self.joint_sub_ = self.create_subscription(JointState,"joint_states", self.jointCallback, 10)        
        self.odom_pub_ = self.create_publisher(Odometry, "mybot_controller/odom", 10)
